    ...
    class Console
    {
        ...
        private void registerInputCommands()
        {
            ...
            Input.Commands["StepThroughHistory"]
                ...
                .Add(this, command =>
                {
                    stepThroughHistory(command.Button);
                });
        }
        #endregion

        #region stepThroughHistory
        private void stepThroughHistory(InputButton direction)
        {
            if (cmdHistoryPosition > 0 && cmdHistoryPosition <= cmdHistory.Count())
            {
                if (direction == InputButton.CursorUp)
                {
            ...
            inputText = cmdHistory[cmdHistoryPosition];
        }
        #endregion
